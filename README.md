...
class Developer {
    constructor(coder) {
        this.name = "Astitwa Dwivedi";
        this.education = "Bachelor of Technology";
        this.institute = "Rajiv Gandhi Institute of Petroleum Technology";
        this.techStack = ["Javascript", "MongoDB", "ReactJS", "ExpressJS", "Ethereum"];
        this.coder = coder;
    }
    ...
    CricketGeek() {
        console.log("Cricket Geek");
    }

    AnimeWeeb() {
        console.log("Anime Weeb");
    }

    TechGossip() {
        console.log("Tech Gossip");
    }
...
console.log("Location:", Billu.getLocation());
Billu.getInterests();
Billu.connection();
